...
For the datasheet, you need to produce a document with the following eight 
...
data creation process. This could be very long, but for this project please 
keep to a maximum of three paragraphs.
...
I prepared from the exam data: [example slides](../pslides/zz_final_project.pdf).
