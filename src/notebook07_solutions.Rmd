...
movies |>
  ggplot(aes(budget, box_office)) +
    geom_point(aes(color = year_release, size = personal_rating)) +
...
movies |>
  ggplot(aes(budget, box_office)) +
    ...
    scale_y_log10() +
    scale_color_viridis_b() +
    labs(x = "Budget (USD)", y = "Box Office", color = "Release Year",
         size = "Personal Rating")
```
...
movies |>
  ggplot(aes(budget, box_office)) +
    ...
    scale_color_viridis_b() +
    labs(x = "Budget (USD)", y = "Box Office", color = "Release Year",
         size = "Personal Rating", title = "Class Movie Data",
         subtitle = "A first attempt at creating our own dataset",
         caption = "We had SOOOO much fun making this!")
```
